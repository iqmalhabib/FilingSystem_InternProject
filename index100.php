...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h4>&nbsp; Pengurusan Pentadbiran : Merekod Surat Masuk dan Keluar</h4>
                </div>
                                ...
                                if($fetchdata > 0)
                                {
                                    ...
                                    foreach($fetchdata as $key => $row)
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $row['jenis'];?></td>
                                            <td>
                                                <a href="edit-contact1.php?id=<?=$key;?>" class="btn btn-primary btn-sm">Edit</a>
                                            </td>
                                            <td>
                ...
                <div class="card-footer text-center">
                    <a href="add-contact100.php" class="btn btn-primary">Tambah surat baru</a>
                </div>
            </div>
        </div>
    </div>
