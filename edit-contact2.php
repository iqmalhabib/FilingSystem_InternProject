                ...
                <div class="card">
                    <div class="card-reader">
                        <h4>
                            ...
                            <a href="index200.php"class="btn btn-danger float-end">Back</a>
                        </h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                               ...
                               <div class="col-md-6">
                                   ...
                                   <div class="form-group mb-3">
                                        <label for="letterType"><strong>Pilih Surat Masuk/Keluar</strong></label>
                                       <select name="letterType" id="letterType" class="form-control" value="<?=$getdata['letterType'];?>" onchange="changeContent()">
                                           <option value="pilih">sila pilih</option>
                                           <option value="keluar" <?php if ($getdata['letterType'] == 'keluar') echo 'selected'; ?>>Surat Keluar</option>
                                           <option value="masuk" <?php if ($getdata['letterType'] == 'masuk') echo 'selected'; ?>>Surat Masuk</option>
                                       </select>
                                   </div>
                                   <div class="form-group mb-3">
                               ...
                               <div class="col-md-6">
                                   ...
                                   <div class="form-group mb-3">
                                       <button type="submit" name="update_contact2" class="btn btn-primary">Update Contact</button>
                                   </div>
                               </div>
                           </div>
                        </form>
